...
- [x] **Sessões de Treino e Máquina de Estados**: Implementar as rotas para criar e gerenciar sessões. Criar a lógica da Máquina de Estados de Sessões (`pending -> in_progress -> paused -> completed`) em `services/sessions.py` e as rotas PATCH de transição correspondentes.
